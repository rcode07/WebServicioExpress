    ...
    <div class="flex flex-col min-h-screen bg-background-light dark:bg-background-dark animate-fade-in font-public relative overflow-hidden">
      ...
      <main class="flex-1 overflow-y-auto pb-32">
        ...
        <div class="px-8 text-center space-y-3">
          <h2 class="text-primary dark:text-blue-400 tracking-tight text-3xl font-black leading-tight">¡Registro Exitoso!</h2>
          <p class="text-slate-500 dark:text-slate-400 text-sm font-bold leading-relaxed max-w-[280px] mx-auto">
            El cliente ha sido dado de alta correctamente en el sistema de seguros médicos.
          </p>
        </div>
        ...
        <div class="flex flex-col gap-4 p-8 mt-4">
          ...
          <button (click)="registerAnother()" class="w-full bg-transparent border-2 border-primary/20 text-primary font-black py-5 rounded-[1.5rem] transition-all active:bg-primary/5 uppercase tracking-widest text-sm active:scale-[0.97]">
